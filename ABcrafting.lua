...
local cra =  { --LEVELS
   ...
   local IDcraft = cra.dragonstone --Change to gems ur cutting
   local preset = 5
...
local function checkbank()
    ...
    for k, v in pairs(items) do
        if v.itemid1 == IDcraft then
            --print("Found: " .. v.itemid1_size .. " uncut gem.")
...
local function craft()
        ...
        API.DoAction_Ability("Uncut dragonstone", 1, API.OFF_ACT_GeneralInterface_route) --change name for the uncut
